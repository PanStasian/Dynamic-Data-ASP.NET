    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                RowStyle-CssClass="td" HeaderStyle-CssClass="th" CellPadding="2" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" ForeColor="Black" GridLines="None">

                <AlternatingRowStyle BackColor="PaleGoldenrod"></AlternatingRowStyle>
                <FooterStyle BackColor="Tan"></FooterStyle>

                <HeaderStyle BackColor="Tan" CssClass="th" Font-Bold="True"></HeaderStyle>

                <PagerStyle CssClass="DDFooter" BackColor="PaleGoldenrod" ForeColor="DarkSlateBlue" HorizontalAlign="Center" />
                <SelectedRowStyle CssClass="DDSelected" BackColor="DarkSlateBlue" ForeColor="GhostWhite" />
